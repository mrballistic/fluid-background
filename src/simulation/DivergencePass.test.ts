/**
 * Unit tests for DivergencePass class
 */
...
describe('DivergencePass', () => {
  ...
  beforeEach(() => {
    ...
    divergencePass = new DivergencePass(gl, shaderManager);
  });
  ...
  describe('execute', () => {
    it('should execute divergence pass with proper uniforms', () => {
      ...
      divergencePass.execute(gl, mockInputs);
    ...
    it('should throw error if not properly initialized', () => {
      const uninitializedPass = new DivergencePass(gl, shaderManager);
      ...
      expect(() => uninitializedPass.execute(gl, mockInputs)).toThrow(
        'DivergencePass not properly initialized'
      );
    });
  });
  ...
  describe('cleanup', () => {
    ...
    it('should handle cleanup when resources are null', () => {
      ...
      expect(() => divergencePass.cleanup()).not.toThrow();
    });
  });
});